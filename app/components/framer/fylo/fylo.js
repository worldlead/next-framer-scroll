...
// https:https://framer.com/m/Seed-aLgb.js@LKLHUZuyFSKjCe09viSw
...
// https:https://esm.sh/v132/typewriter-effect@2.21.0/node/typewriter-effect.mjs
var require2 = (n,) => {
...
var cycleOrder = ['R_0SntBXV', 'RspHZjbvA', 'KzyHUFutd', 'lR29aQ4aC',];
...
var humanReadableVariantMap = { expanded: 'KzyHUFutd', search: 'R_0SntBXV', seed: 'RspHZjbvA', type: 'lR29aQ4aC', };
var getProps = ({ height, id, tap2, width, ...props },) => {
  var _variant, ref;
  return {
    ...props,
    QTUGimW1J: tap2 !== null && tap2 !== void 0 ? tap2 : props.QTUGimW1J,
    variant:
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref,) {
  ...
  const { style, className, layoutId, variant, QTUGimW1J, ...restProps } = getProps(props,);
  ...
  const onTap1rg3pbc = activeVariantCallback(async (...args) => {
    if (QTUGimW1J) {
      const res = await QTUGimW1J(...args,);
      if (res === false) {
        return false;
      }
    }
    setVariant('KzyHUFutd',);
  },);
  const isDisplayed = () => {
    if (baseVariant === 'RspHZjbvA') {
      return false;
    }
    return true;
  };
  const isDisplayed1 = () => {
    if (baseVariant === 'lR29aQ4aC') {
      return false;
    }
    return true;
  };
  ...
  return /* @__PURE__ */ _jsx2(LayoutGroup, {
    ...
    children: /* @__PURE__ */ _jsx2(motion.div, {
      ...
      className: cx('framer-KfwuH', classNames,),
      style: { display: 'contents', },
      children: /* @__PURE__ */ _jsx2(Transition, {
        ...
        children: /* @__PURE__ */ _jsx2(motion.div, {
          ...
          ...addPropertyOverrides(
            {
              ...
              RspHZjbvA: { 'data-framer-name': 'seed', 'data-highlight': void 0, onTap: void 0, },
            },
            baseVariant,
            gestureVariant,
          ),
          children: /* @__PURE__ */ _jsx2(motion.div, {
            ...
            transformTemplate,
            ...addPropertyOverrides({ lR29aQ4aC: { transformTemplate: void 0, }, }, baseVariant, gestureVariant,),
            children: /* @__PURE__ */ _jsxs(motion.div, {
              ...
              children: [
                /* @__PURE__ */ _jsxs(motion.div, {
                  ...
                  variants: { lR29aQ4aC: { backgroundColor: 'rgba(0, 0, 0, 0)', }, },
                  children: [
                    ...
                    isDisplayed() && /* @__PURE__ */ _jsxs(motion.div, {
                      ...
                      children: [
                        ...
                        isDisplayed2() && /* @__PURE__ */ _jsx2(motion.div, {
                    ...
                    /* @__PURE__ */ _jsxs(motion.div, {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ _jsx2(SVG, {
                          ...
                          layoutId: 'tKSDkNvVI',
                          svg:
                            '<svg width="50" height="49" viewBox="0 0 50 49" fill="none" xmlns="http://www.w3.org/2000/svg">\n<rect x="0.5" width="49" height="49" rx="24.5" fill="#D2D8E8"/>\n<path d="M23.1116 22.5702C24.0048 21.6188 24.5844 20.4555 25.164 19.2923C26.5219 16.5668 27.8798 13.8413 33.2708 13.8413L35.0426 13.8413C36.6154 13.8413 37.7792 15.1164 37.7789 16.6891C37.7786 18.2614 36.5039 19.5358 34.9316 19.5358L33.2697 19.5358C27.8788 19.5358 26.5208 21.8178 25.1629 24.0997C25.04 24.3062 24.9172 24.5126 24.7913 24.7174C24.9172 24.9242 25.04 25.1327 25.1629 25.3412C26.5208 27.646 27.8788 29.9508 33.2697 29.9508L35.1752 29.9508C36.613 29.9508 37.7786 31.1162 37.7789 32.554C37.7792 33.9923 36.6134 35.1583 35.1752 35.1583L33.2708 35.1583C27.8798 35.1583 26.5219 32.5546 25.164 29.9508C24.5871 28.8446 24.0102 27.7385 23.1241 26.832C21.9244 27.9082 20.1578 28.6636 17.0561 28.6636L16.1866 28.6636C13.9962 28.6636 12.2206 26.8879 12.2206 24.6976C12.2206 22.5072 13.9962 20.7316 16.1866 20.7316L17.0561 20.7316C20.147 20.7316 21.9121 21.4892 23.1116 22.5702Z" fill="#101942"/>\n<path d="M23.1116 22.5702C24.0048 21.6188 24.5844 20.4555 25.164 19.2923C26.5219 16.5668 27.8798 13.8413 33.2708 13.8413L35.0426 13.8413C36.6154 13.8413 37.7792 15.1164 37.7789 16.6891C37.7786 18.2614 36.5039 19.5358 34.9316 19.5358L33.2697 19.5358C27.8788 19.5358 26.5208 21.8178 25.1629 24.0997C25.04 24.3062 24.9172 24.5126 24.7913 24.7174C24.9172 24.9242 25.04 25.1327 25.1629 25.3412C26.5208 27.646 27.8788 29.9508 33.2697 29.9508L35.1752 29.9508C36.613 29.9508 37.7786 31.1162 37.7789 32.554C37.7792 33.9923 36.6134 35.1583 35.1752 35.1583L33.2708 35.1583C27.8798 35.1583 26.5219 32.5546 25.164 29.9508C24.5871 28.8446 24.0102 27.7385 23.1241 26.832C21.9244 27.9082 20.1578 28.6636 17.0561 28.6636L16.1866 28.6636C13.9962 28.6636 12.2206 26.8879 12.2206 24.6976C12.2206 22.5072 13.9962 20.7316 16.1866 20.7316L17.0561 20.7316C20.147 20.7316 21.9121 21.4892 23.1116 22.5702Z" stroke="#101942"/>\n</svg>\n',
                          withExternalLayout: true,
                        },),
                      ],
                    },),
...
var css = [
  '.framer-KfwuH [data-border="true"]::after { content: ""; border-width: var(--border-top-width, 0) var(--border-right-width, 0) var(--border-bottom-width, 0) var(--border-left-width, 0); border-color: var(--border-color, none); border-style: var(--border-style, none); width: 100%; height: 100%; position: absolute; box-sizing: border-box; left: 0; top: 0; border-radius: inherit; pointer-events: none; }',
  '@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }',
  '.framer-KfwuH .framer-b9y4c0 { display: block; }',
  '.framer-KfwuH .framer-1xd6uv3 { cursor: pointer; height: 537px; overflow: hidden; position: relative; width: 1009px; }',
  '.framer-KfwuH .framer-th6quy { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 4px; height: min-content; justify-content: flex-start; left: 50%; overflow: hidden; padding: 0px 0px 0px 0px; position: absolute; top: 50%; width: 360px; will-change: var(--framer-will-change-override, transform); }',
  '.framer-KfwuH .framer-102rpj4 { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: column; flex-wrap: nowrap; gap: 4px; height: 100%; justify-content: flex-start; overflow: visible; padding: 4px 4px 4px 4px; position: relative; width: 1px; z-index: 1; }',
  '.framer-KfwuH .framer-1x3xeex { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 4px; height: min-content; justify-content: flex-start; overflow: visible; padding: 0px 0px 0px 0px; position: relative; width: 100%; }',
  '.framer-KfwuH .framer-onwzwe, .framer-KfwuH .framer-8y7dsi { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: 48px; justify-content: center; overflow: visible; padding: 0px 0px 0px 0px; position: relative; width: 48px; }',
  '.framer-KfwuH .framer-1d3you, .framer-KfwuH .framer-vyt6dv { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 0px 0px 0px 0px; position: relative; width: min-content; will-change: var(--framer-will-change-override, transform); }',
  '.framer-KfwuH .framer-1klpfuo, .framer-KfwuH .framer-1o52rms { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: visible; padding: 8px 8px 8px 8px; position: relative; width: min-content; }',
  '.framer-KfwuH .framer-4hz2zg, .framer-KfwuH .framer-1xo5sxg { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 24px); overflow: visible; position: relative; width: 24px; }',
  '.framer-KfwuH .framer-1pd2dzy { bottom: 4px; flex: none; left: 4px; position: absolute; right: 5px; top: 4px; }',
  '.framer-KfwuH .framer-2jm16e { bottom: 6px; flex: none; left: 3px; position: absolute; right: 3px; top: 6px; }',
  '.framer-KfwuH .framer-a5vvyf { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 49px; justify-content: flex-start; overflow: visible; padding: 0px 0px 0px 0px; position: relative; width: 1px; }',
  '.framer-KfwuH .framer-er2jrd, .framer-KfwuH .framer-1s5l2r8, .framer-KfwuH .framer-16jmr7f, .framer-KfwuH .framer-1j2s96v { flex: none; height: auto; position: relative; white-space: pre; width: auto; }',
  '.framer-KfwuH .framer-b3bbqg { align-content: flex-start; align-items: flex-start; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: flex-start; overflow: hidden; padding: 0px 0px 0px 0px; position: relative; width: 1px; }',
  '.framer-KfwuH .framer-q46j6z-container { flex: 1 0 0px; height: 50px; position: relative; width: 1px; }',
  '.framer-KfwuH .framer-o3gcmt { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 0px; height: min-content; justify-content: flex-end; overflow: visible; padding: 0px 0px 0px 0px; position: relative; width: min-content; }',
  '.framer-KfwuH .framer-dpkc67 { bottom: 4px; flex: none; left: 3px; position: absolute; right: 4px; top: 3px; }',
  '.framer-KfwuH .framer-fog67b { flex: none; height: 49px; position: relative; width: 50px; }',
  '.framer-KfwuH .framer-4fuql9 { align-content: flex-start; align-items: flex-start; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 4px; height: min-content; justify-content: flex-start; overflow: visible; padding: 4px 4px 4px 4px; position: relative; width: 100%; }',
  '.framer-KfwuH .framer-9xr0lm, .framer-KfwuH .framer-1j7qf8c, .framer-KfwuH .framer-1oqfwc7 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: column; flex-wrap: nowrap; gap: 8px; height: 40px; justify-content: center; overflow: hidden; padding: 0px 0px 0px 0px; position: relative; width: 100%; will-change: var(--framer-will-change-override, transform); }',
  '.framer-KfwuH .framer-jg6s93, .framer-KfwuH .framer-r697fa, .framer-KfwuH .framer-i9rcfr { align-content: center; align-items: center; display: flex; flex: 1 0 0px; flex-direction: row; flex-wrap: nowrap; gap: 8px; height: 1px; justify-content: center; overflow: visible; padding: 10px 16px 10px 12px; position: relative; width: 100%; }',
  '.framer-KfwuH .framer-1trg1ag, .framer-KfwuH .framer-1l3eqf8, .framer-KfwuH .framer-1cp1dxx { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 18px); overflow: visible; position: relative; width: 18px; }',
  '.framer-KfwuH .framer-15peqkh, .framer-KfwuH .framer-1e7nb68, .framer-KfwuH .framer-1n3aflp { bottom: 3px; flex: none; left: 3px; position: absolute; right: 3px; top: 3px; }',
  '@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-KfwuH .framer-th6quy, .framer-KfwuH .framer-102rpj4, .framer-KfwuH .framer-1x3xeex, .framer-KfwuH .framer-onwzwe, .framer-KfwuH .framer-1d3you, .framer-KfwuH .framer-1klpfuo, .framer-KfwuH .framer-a5vvyf, .framer-KfwuH .framer-b3bbqg, .framer-KfwuH .framer-o3gcmt, .framer-KfwuH .framer-8y7dsi, .framer-KfwuH .framer-vyt6dv, .framer-KfwuH .framer-1o52rms, .framer-KfwuH .framer-4fuql9, .framer-KfwuH .framer-9xr0lm, .framer-KfwuH .framer-jg6s93, .framer-KfwuH .framer-1j7qf8c, .framer-KfwuH .framer-r697fa, .framer-KfwuH .framer-1oqfwc7, .framer-KfwuH .framer-i9rcfr { gap: 0px; } .framer-KfwuH .framer-th6quy > *, .framer-KfwuH .framer-1x3xeex > * { margin: 0px; margin-left: calc(4px / 2); margin-right: calc(4px / 2); } .framer-KfwuH .framer-th6quy > :first-child, .framer-KfwuH .framer-1x3xeex > :first-child, .framer-KfwuH .framer-1d3you > :first-child, .framer-KfwuH .framer-1klpfuo > :first-child, .framer-KfwuH .framer-a5vvyf > :first-child, .framer-KfwuH .framer-b3bbqg > :first-child, .framer-KfwuH .framer-o3gcmt > :first-child, .framer-KfwuH .framer-vyt6dv > :first-child, .framer-KfwuH .framer-1o52rms > :first-child, .framer-KfwuH .framer-jg6s93 > :first-child, .framer-KfwuH .framer-r697fa > :first-child, .framer-KfwuH .framer-i9rcfr > :first-child { margin-left: 0px; } .framer-KfwuH .framer-th6quy > :last-child, .framer-KfwuH .framer-1x3xeex > :last-child, .framer-KfwuH .framer-1d3you > :last-child, .framer-KfwuH .framer-1klpfuo > :last-child, .framer-KfwuH .framer-a5vvyf > :last-child, .framer-KfwuH .framer-b3bbqg > :last-child, .framer-KfwuH .framer-o3gcmt > :last-child, .framer-KfwuH .framer-vyt6dv > :last-child, .framer-KfwuH .framer-1o52rms > :last-child, .framer-KfwuH .framer-jg6s93 > :last-child, .framer-KfwuH .framer-r697fa > :last-child, .framer-KfwuH .framer-i9rcfr > :last-child { margin-right: 0px; } .framer-KfwuH .framer-102rpj4 > *, .framer-KfwuH .framer-4fuql9 > * { margin: 0px; margin-bottom: calc(4px / 2); margin-top: calc(4px / 2); } .framer-KfwuH .framer-102rpj4 > :first-child, .framer-KfwuH .framer-onwzwe > :first-child, .framer-KfwuH .framer-8y7dsi > :first-child, .framer-KfwuH .framer-4fuql9 > :first-child, .framer-KfwuH .framer-9xr0lm > :first-child, .framer-KfwuH .framer-1j7qf8c > :first-child, .framer-KfwuH .framer-1oqfwc7 > :first-child { margin-top: 0px; } .framer-KfwuH .framer-102rpj4 > :last-child, .framer-KfwuH .framer-onwzwe > :last-child, .framer-KfwuH .framer-8y7dsi > :last-child, .framer-KfwuH .framer-4fuql9 > :last-child, .framer-KfwuH .framer-9xr0lm > :last-child, .framer-KfwuH .framer-1j7qf8c > :last-child, .framer-KfwuH .framer-1oqfwc7 > :last-child { margin-bottom: 0px; } .framer-KfwuH .framer-onwzwe > *, .framer-KfwuH .framer-8y7dsi > * { margin: 0px; margin-bottom: calc(10px / 2); margin-top: calc(10px / 2); } .framer-KfwuH .framer-1d3you > *, .framer-KfwuH .framer-1klpfuo > *, .framer-KfwuH .framer-a5vvyf > *, .framer-KfwuH .framer-b3bbqg > *, .framer-KfwuH .framer-vyt6dv > *, .framer-KfwuH .framer-1o52rms > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-KfwuH .framer-o3gcmt > * { margin: 0px; margin-left: calc(0px / 2); margin-right: calc(0px / 2); } .framer-KfwuH .framer-9xr0lm > *, .framer-KfwuH .framer-1j7qf8c > *, .framer-KfwuH .framer-1oqfwc7 > * { margin: 0px; margin-bottom: calc(8px / 2); margin-top: calc(8px / 2); } .framer-KfwuH .framer-jg6s93 > *, .framer-KfwuH .framer-r697fa > *, .framer-KfwuH .framer-i9rcfr > * { margin: 0px; margin-left: calc(8px / 2); margin-right: calc(8px / 2); } }',
  '.framer-KfwuH.framer-v-15mvvd2 .framer-1xd6uv3 { cursor: unset; }',
  '.framer-KfwuH.framer-v-15mvvd2 .framer-th6quy, .framer-KfwuH.framer-v-15mvvd2 .framer-1x3xeex { width: min-content; }',
  '.framer-KfwuH.framer-v-15mvvd2 .framer-102rpj4 { flex: none; width: min-content; }',
  '.framer-KfwuH.framer-v-1u2jgkx .framer-102rpj4 { flex: none; width: 360px; }',
  '.framer-KfwuH.framer-v-15ekw7u .framer-th6quy { height: 57px; left: calc(50.04955401387514% - 584px / 2); top: calc(49.90689013035384% - 57px / 2); width: 584px; }',
];
var FramerpSxPslti_ = withCSS2(Component, css, 'framer-KfwuH',);
...
addPropertyControls2(FramerpSxPslti_, {
  variant: {
    options: ['R_0SntBXV', 'RspHZjbvA', 'KzyHUFutd', 'lR29aQ4aC',],
    optionTitles: ['search', 'seed', 'expanded', 'type',],
    title: 'Variant',
    type: ControlType2.Enum,
  },
  QTUGimW1J: { title: 'Tap 2', type: ControlType2.EventHandler, },
},);
...
var fylo_default = stdin_default;
