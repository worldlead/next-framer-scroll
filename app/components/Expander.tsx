      ...
      >
        <div className="opacity-wrapper">
          <div className="h-screen absolute top-0 left-0 w-full sm:px-[7.5rem] py-[12rem]">
            <div className="absolute left-0 w-full card-stack-wrapper"></div>
            <div className="hidden sm:w-unset absolute sm:left-1/2 sm:top-1/2 flex-col sm:w-1/2 px-8 sm:px-[56px] bottom-[100px] items-center">
              <h1 className={`text-spectrum-space w-[50%] text-center leading-trim-cap font-pp-supply-sans text-[30px] sm:text-[48px] font-light leading-24 tracking-1.6 ${isCircleMaskOn ? "hidden" : "hidden"}`}>
                ideation, evolved.
              </h1>
              <a
