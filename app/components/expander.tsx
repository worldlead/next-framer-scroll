...
export default function Expander({ className }: ExpanderProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed flex opacity-0.5 left-1/2 -translate-x-1/2 justify-center ${isCircleMaskOn ? "z-[99]" : ""}`}
      >
        {isCircleMaskOn && (
      ...
      <div
        ref={bannerText}
        className={`${className}flex items-center transition z-50 opacity-0 animated-fade-in`}
      >
        <h1
